...
my $basic =
    SignalWire::SWAIG::FunctionResult->new('Starting basic call recording')
    ->record_call()
...
my $advanced =
    SignalWire::SWAIG::FunctionResult->new('Starting advanced call recording')->record_call(
...
my $stop =
    SignalWire::SWAIG::FunctionResult->new('Ending call recording')
...
my $cs_end =
    SignalWire::SWAIG::FunctionResult->new('Call recording stopped')
...
my $compliance =
    SignalWire::SWAIG::FunctionResult->new('This call is being recorded for compliance purposes')
    ->record_call(
