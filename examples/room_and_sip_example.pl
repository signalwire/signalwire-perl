...
my $room =
    SignalWire::SWAIG::FunctionResult->new('Joining the support team room')
...
my $conf =
    SignalWire::SWAIG::FunctionResult->new('Setting up daily standup meeting')
...
my $sip =
    SignalWire::SWAIG::FunctionResult->new('Transferring your call to support')
...
my $adv_sip =
    SignalWire::SWAIG::FunctionResult->new('Transferring to technical support')
    ->set_metadata(
    {
...
my $join =
    SignalWire::SWAIG::FunctionResult->new('Connecting to customer service')
...
my $escalate =
    SignalWire::SWAIG::FunctionResult->new('Escalating to manager')
...
my $simple_conf =
    SignalWire::SWAIG::FunctionResult->new('Joining team conference')
