...
eval {
    $agent->add_skill(
        'datasphere',
        {
            ...
            distance           => 5.0,
            no_results_message =>
                "I couldn't find any drink recipes about '{query}'. Try a different cocktail.",
        }
    );
...
eval {
    $agent->add_skill(
        'datasphere',
        {
            ...
            distance           => 4.0,
            no_results_message =>
                "I couldn't find cooking information about '{query}'. Try a different dish.",
        }
    );
...
eval {
    $agent->add_skill(
        'datasphere',
        {
            ...
            distance           => 3.0,
            no_results_message =>
                "I couldn't find information about '{query}'. Please try rephrasing.",
        }
    );
