...
##
{
    my $elem = new WWW::SignalWire::LaML;
    $elem->name('Dial');
...
##
{
    is( WWW::SignalWire::LaML->new->to_string, q!<?xml version="1.0" encoding="UTF-8" ?>
!, "to_string example 1" );
}
...
{
    is( WWW::SignalWire::LaML->new->Response->Say("plugh")->root->to_string,
...
{
    is( WWW::SignalWire::LaML->new->Response->Say("plugh")->to_string,
