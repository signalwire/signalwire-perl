...
#
# Generated REST wire type 'LogResponse' from the 'fax' spec (components/schemas 'LogResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fax::LogResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fax::LogResponse: pure data DTO (wire-response shape, not an exception).
