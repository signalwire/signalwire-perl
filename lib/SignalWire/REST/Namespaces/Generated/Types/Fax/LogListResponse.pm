...
#
# Generated REST wire type 'LogListResponse' from the 'fax' spec (components/schemas 'LogListResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fax::LogListResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fax::LogListResponse: pure data DTO (wire-response shape, not an exception).
