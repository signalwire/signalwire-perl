...
#
# Generated REST wire type 'RoomResponse' from the 'video' spec (components/schemas 'RoomResponse').
package SignalWire::REST::Namespaces::Generated::Types::Video::RoomResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Video::RoomResponse: pure data DTO (wire-response shape, not an exception).
