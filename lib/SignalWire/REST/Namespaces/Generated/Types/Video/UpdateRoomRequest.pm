...
#
# Generated REST wire type 'UpdateRoomRequest' from the 'video' spec (components/schemas 'UpdateRoomRequest').
package SignalWire::REST::Namespaces::Generated::Types::Video::UpdateRoomRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Video::UpdateRoomRequest: pure data DTO (wire-response shape, not an exception).
