...
#
# Generated REST wire type 'ChargeDetail' from the 'video' spec (components/schemas 'ChargeDetail').
package SignalWire::REST::Namespaces::Generated::Types::Video::ChargeDetail;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Video::ChargeDetail: pure data DTO (wire-response shape, not an exception).
