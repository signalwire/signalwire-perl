...
#
# Generated REST wire type 'RoomSessionSummary' from the 'video' spec (components/schemas 'RoomSessionSummary').
package SignalWire::REST::Namespaces::Generated::Types::Video::RoomSessionSummary;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Video::RoomSessionSummary: pure data DTO (wire-response shape, not an exception).
