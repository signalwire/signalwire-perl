...
#
# Generated REST wire type 'SayAction' from the 'fabric' spec (components/schemas 'SayAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SayAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SayAction: pure data DTO (wire-response shape, not an exception).
