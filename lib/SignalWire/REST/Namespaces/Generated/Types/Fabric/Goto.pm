...
#
# Generated REST wire type 'Goto' from the 'fabric' spec (components/schemas 'Goto').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Goto;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Goto: pure data DTO (wire-response shape, not an exception).
