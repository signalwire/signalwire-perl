...
#
# Generated REST wire type 'UserInputAction' from the 'fabric' spec (components/schemas 'UserInputAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::UserInputAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::UserInputAction: pure data DTO (wire-response shape, not an exception).
