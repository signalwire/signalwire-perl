...
#
# Generated REST wire type 'SipEndpointCreateRequest' from the 'fabric' spec (components/schemas 'SipEndpointCreateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SipEndpointCreateRequest;
use strict;
use warnings;
use Moo;
