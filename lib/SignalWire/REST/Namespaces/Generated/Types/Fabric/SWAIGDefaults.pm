...
#
# Generated REST wire type 'SWAIGDefaults' from the 'fabric' spec (components/schemas 'SWAIGDefaults').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SWAIGDefaults;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SWAIGDefaults: pure data DTO (wire-response shape, not an exception).
