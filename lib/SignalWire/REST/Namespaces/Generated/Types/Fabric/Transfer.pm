...
#
# Generated REST wire type 'Transfer' from the 'fabric' spec (components/schemas 'Transfer').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Transfer;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Transfer: pure data DTO (wire-response shape, not an exception).
