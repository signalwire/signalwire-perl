...
#
# Generated REST wire type 'NullProperty' from the 'fabric' spec (components/schemas 'NullProperty').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::NullProperty;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::NullProperty: pure data DTO (wire-response shape, not an exception).
