...
#
# Generated REST wire type 'ResourceResponseCallFlow' from the 'fabric' spec (components/schemas 'ResourceResponseCallFlow').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseCallFlow;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseCallFlow: pure data DTO (wire-response shape, not an exception).
