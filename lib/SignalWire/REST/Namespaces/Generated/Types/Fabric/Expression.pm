...
#
# Generated REST wire type 'Expression' from the 'fabric' spec (components/schemas 'Expression').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Expression;
use strict;
use warnings;
use Moo;
