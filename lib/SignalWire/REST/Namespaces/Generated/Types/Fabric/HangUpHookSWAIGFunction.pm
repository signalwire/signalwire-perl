...
#
# Generated REST wire type 'HangUpHookSWAIGFunction' from the 'fabric' spec (components/schemas 'HangUpHookSWAIGFunction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::HangUpHookSWAIGFunction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::HangUpHookSWAIGFunction: pure data DTO (wire-response shape, not an exception).
