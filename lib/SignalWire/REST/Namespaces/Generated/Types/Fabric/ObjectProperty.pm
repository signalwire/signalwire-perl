...
#
# Generated REST wire type 'ObjectProperty' from the 'fabric' spec (components/schemas 'ObjectProperty').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ObjectProperty;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ObjectProperty: pure data DTO (wire-response shape, not an exception).
