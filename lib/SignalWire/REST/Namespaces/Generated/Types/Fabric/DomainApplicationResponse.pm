...
#
# Generated REST wire type 'DomainApplicationResponse' from the 'fabric' spec (components/schemas 'DomainApplicationResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::DomainApplicationResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::DomainApplicationResponse: pure data DTO (wire-response shape, not an exception).
