...
#
# Generated REST wire type 'ResourceResponseCXMLScript' from the 'fabric' spec (components/schemas 'ResourceResponseCXMLScript').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseCXMLScript;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseCXMLScript: pure data DTO (wire-response shape, not an exception).
