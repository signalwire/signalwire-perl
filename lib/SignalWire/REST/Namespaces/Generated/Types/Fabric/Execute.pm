...
#
# Generated REST wire type 'Execute' from the 'fabric' spec (components/schemas 'Execute').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Execute;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Execute: pure data DTO (wire-response shape, not an exception).
