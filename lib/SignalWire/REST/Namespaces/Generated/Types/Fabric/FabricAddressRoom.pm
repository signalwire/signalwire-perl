...
#
# Generated REST wire type 'FabricAddressRoom' from the 'fabric' spec (components/schemas 'FabricAddressRoom').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddressRoom;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddressRoom: pure data DTO (wire-response shape, not an exception).
