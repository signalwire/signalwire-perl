...
#
# Generated REST wire type 'CXMLWebhookResponse' from the 'fabric' spec (components/schemas 'CXMLWebhookResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CXMLWebhookResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::CXMLWebhookResponse: pure data DTO (wire-response shape, not an exception).
