...
#
# Generated REST wire type 'StartUpHookSWAIGFunction' from the 'fabric' spec (components/schemas 'StartUpHookSWAIGFunction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::StartUpHookSWAIGFunction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::StartUpHookSWAIGFunction: pure data DTO (wire-response shape, not an exception).
