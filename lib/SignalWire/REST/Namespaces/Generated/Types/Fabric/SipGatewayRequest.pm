...
#
# Generated REST wire type 'SipGatewayRequest' from the 'fabric' spec (components/schemas 'SipGatewayRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SipGatewayRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SipGatewayRequest: pure data DTO (wire-response shape, not an exception).
