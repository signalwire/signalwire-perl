...
#
# Generated REST wire type 'AudioChannel' from the 'fabric' spec (components/schemas 'AudioChannel').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::AudioChannel;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::AudioChannel: pure data DTO (wire-response shape, not an exception).
