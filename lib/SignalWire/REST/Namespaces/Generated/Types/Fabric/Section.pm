...
#
# Generated REST wire type 'Section' from the 'fabric' spec (components/schemas 'Section').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Section;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Section: pure data DTO (wire-response shape, not an exception).
