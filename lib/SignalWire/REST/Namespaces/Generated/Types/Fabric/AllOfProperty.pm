...
#
# Generated REST wire type 'AllOfProperty' from the 'fabric' spec (components/schemas 'AllOfProperty').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::AllOfProperty;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::AllOfProperty: pure data DTO (wire-response shape, not an exception).
