...
#
# Generated REST wire type 'SWAIGUpdate' from the 'fabric' spec (components/schemas 'SWAIGUpdate').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SWAIGUpdate;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SWAIGUpdate: pure data DTO (wire-response shape, not an exception).
