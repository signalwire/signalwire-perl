...
#
# Generated REST wire type 'JoinRoom' from the 'fabric' spec (components/schemas 'JoinRoom').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::JoinRoom;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::JoinRoom: pure data DTO (wire-response shape, not an exception).
