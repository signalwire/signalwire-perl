...
#
# Generated REST wire type 'Tap' from the 'fabric' spec (components/schemas 'Tap').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Tap;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Tap: pure data DTO (wire-response shape, not an exception).
