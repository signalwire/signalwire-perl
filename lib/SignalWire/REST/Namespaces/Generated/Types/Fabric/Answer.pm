...
#
# Generated REST wire type 'Answer' from the 'fabric' spec (components/schemas 'Answer').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Answer;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Answer: pure data DTO (wire-response shape, not an exception).
