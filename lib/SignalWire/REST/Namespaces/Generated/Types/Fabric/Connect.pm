...
#
# Generated REST wire type 'Connect' from the 'fabric' spec (components/schemas 'Connect').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Connect;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Connect: pure data DTO (wire-response shape, not an exception).
