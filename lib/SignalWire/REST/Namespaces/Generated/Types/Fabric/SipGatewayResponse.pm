...
#
# Generated REST wire type 'SipGatewayResponse' from the 'fabric' spec (components/schemas 'SipGatewayResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SipGatewayResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SipGatewayResponse: pure data DTO (wire-response shape, not an exception).
