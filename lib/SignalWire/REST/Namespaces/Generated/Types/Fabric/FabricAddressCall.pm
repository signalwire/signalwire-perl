...
#
# Generated REST wire type 'FabricAddressCall' from the 'fabric' spec (components/schemas 'FabricAddressCall').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddressCall;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddressCall: pure data DTO (wire-response shape, not an exception).
