...
#
# Generated REST wire type 'SendDigits' from the 'fabric' spec (components/schemas 'SendDigits').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SendDigits;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SendDigits: pure data DTO (wire-response shape, not an exception).
