...
#
# Generated REST wire type 'SipEndpointResponse' from the 'fabric' spec (components/schemas 'SipEndpointResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SipEndpointResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SipEndpointResponse: pure data DTO (wire-response shape, not an exception).
