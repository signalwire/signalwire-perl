...
#
# Generated REST wire type 'ResourceResponseSWMLScript' from the 'fabric' spec (components/schemas 'ResourceResponseSWMLScript').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSWMLScript;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSWMLScript: pure data DTO (wire-response shape, not an exception).
