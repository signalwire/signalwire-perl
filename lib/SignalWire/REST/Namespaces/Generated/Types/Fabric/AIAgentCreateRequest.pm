...
#
# Generated REST wire type 'AIAgentCreateRequest' from the 'fabric' spec (components/schemas 'AIAgentCreateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::AIAgentCreateRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::AIAgentCreateRequest: pure data DTO (wire-response shape, not an exception).
