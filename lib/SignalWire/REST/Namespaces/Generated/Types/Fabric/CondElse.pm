...
#
# Generated REST wire type 'CondElse' from the 'fabric' spec (components/schemas 'CondElse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CondElse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::CondElse: pure data DTO (wire-response shape, not an exception).
