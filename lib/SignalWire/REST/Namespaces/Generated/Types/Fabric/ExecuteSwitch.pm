...
#
# Generated REST wire type 'ExecuteSwitch' from the 'fabric' spec (components/schemas 'ExecuteSwitch').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ExecuteSwitch;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ExecuteSwitch: pure data DTO (wire-response shape, not an exception).
