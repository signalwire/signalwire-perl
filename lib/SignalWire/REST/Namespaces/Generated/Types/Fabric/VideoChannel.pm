...
#
# Generated REST wire type 'VideoChannel' from the 'fabric' spec (components/schemas 'VideoChannel').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::VideoChannel;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::VideoChannel: pure data DTO (wire-response shape, not an exception).
