...
#
# Generated REST wire type 'AIAgentResponse' from the 'fabric' spec (components/schemas 'AIAgentResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::AIAgentResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::AIAgentResponse: pure data DTO (wire-response shape, not an exception).
