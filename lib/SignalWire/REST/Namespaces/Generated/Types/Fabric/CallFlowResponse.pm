...
#
# Generated REST wire type 'CallFlowResponse' from the 'fabric' spec (components/schemas 'CallFlowResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CallFlowResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::CallFlowResponse: pure data DTO (wire-response shape, not an exception).
