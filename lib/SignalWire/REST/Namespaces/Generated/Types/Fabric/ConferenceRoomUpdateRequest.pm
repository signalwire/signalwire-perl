...
#
# Generated REST wire type 'ConferenceRoomUpdateRequest' from the 'fabric' spec (components/schemas 'ConferenceRoomUpdateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ConferenceRoomUpdateRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ConferenceRoomUpdateRequest: pure data DTO (wire-response shape, not an exception).
