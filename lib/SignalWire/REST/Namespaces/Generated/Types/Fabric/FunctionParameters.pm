...
#
# Generated REST wire type 'FunctionParameters' from the 'fabric' spec (components/schemas 'FunctionParameters').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::FunctionParameters;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::FunctionParameters: pure data DTO (wire-response shape, not an exception).
