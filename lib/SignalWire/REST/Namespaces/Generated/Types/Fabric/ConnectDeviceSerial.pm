...
#
# Generated REST wire type 'ConnectDeviceSerial' from the 'fabric' spec (components/schemas 'ConnectDeviceSerial').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ConnectDeviceSerial;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ConnectDeviceSerial: pure data DTO (wire-response shape, not an exception).
