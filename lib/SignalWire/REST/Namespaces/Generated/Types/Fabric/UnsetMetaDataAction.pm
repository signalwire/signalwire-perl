...
#
# Generated REST wire type 'UnsetMetaDataAction' from the 'fabric' spec (components/schemas 'UnsetMetaDataAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::UnsetMetaDataAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::UnsetMetaDataAction: pure data DTO (wire-response shape, not an exception).
