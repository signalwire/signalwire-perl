...
#
# Generated REST wire type 'SWMLWebhookUpdateRequest' from the 'fabric' spec (components/schemas 'SWMLWebhookUpdateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLWebhookUpdateRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLWebhookUpdateRequest: pure data DTO (wire-response shape, not an exception).
