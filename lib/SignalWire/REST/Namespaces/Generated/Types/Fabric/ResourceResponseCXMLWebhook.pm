...
#
# Generated REST wire type 'ResourceResponseCXMLWebhook' from the 'fabric' spec (components/schemas 'ResourceResponseCXMLWebhook').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseCXMLWebhook;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseCXMLWebhook: pure data DTO (wire-response shape, not an exception).
