...
#
# Generated REST wire type 'SWAIGIncludes' from the 'fabric' spec (components/schemas 'SWAIGIncludes').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SWAIGIncludes;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SWAIGIncludes: pure data DTO (wire-response shape, not an exception).
