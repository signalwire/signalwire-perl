...
#
# Generated REST wire type 'CXMLWebhookUpdateRequest' from the 'fabric' spec (components/schemas 'CXMLWebhookUpdateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CXMLWebhookUpdateRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::CXMLWebhookUpdateRequest: pure data DTO (wire-response shape, not an exception).
