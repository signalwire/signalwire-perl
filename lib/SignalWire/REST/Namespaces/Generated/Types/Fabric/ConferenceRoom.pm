...
#
# Generated REST wire type 'ConferenceRoom' from the 'fabric' spec (components/schemas 'ConferenceRoom').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ConferenceRoom;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ConferenceRoom: pure data DTO (wire-response shape, not an exception).
