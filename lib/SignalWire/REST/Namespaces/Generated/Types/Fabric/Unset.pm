...
#
# Generated REST wire type 'Unset' from the 'fabric' spec (components/schemas 'Unset').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Unset;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Unset: pure data DTO (wire-response shape, not an exception).
