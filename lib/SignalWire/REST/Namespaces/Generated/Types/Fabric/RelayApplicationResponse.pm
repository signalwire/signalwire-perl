...
#
# Generated REST wire type 'RelayApplicationResponse' from the 'fabric' spec (components/schemas 'RelayApplicationResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::RelayApplicationResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::RelayApplicationResponse: pure data DTO (wire-response shape, not an exception).
