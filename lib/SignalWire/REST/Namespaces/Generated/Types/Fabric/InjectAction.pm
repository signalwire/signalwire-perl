...
#
# Generated REST wire type 'InjectAction' from the 'fabric' spec (components/schemas 'InjectAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::InjectAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::InjectAction: pure data DTO (wire-response shape, not an exception).
