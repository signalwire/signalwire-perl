...
#
# Generated REST wire type 'ConnectDeviceParallel' from the 'fabric' spec (components/schemas 'ConnectDeviceParallel').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ConnectDeviceParallel;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ConnectDeviceParallel: pure data DTO (wire-response shape, not an exception).
