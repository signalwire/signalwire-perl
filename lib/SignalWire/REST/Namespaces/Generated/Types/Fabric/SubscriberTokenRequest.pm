...
#
# Generated REST wire type 'SubscriberTokenRequest' from the 'fabric' spec (components/schemas 'SubscriberTokenRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SubscriberTokenRequest;
use strict;
use warnings;
use Moo;
