...
#
# Generated REST wire type 'Denoise' from the 'fabric' spec (components/schemas 'Denoise').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Denoise;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Denoise: pure data DTO (wire-response shape, not an exception).
