...
#
# Generated REST wire type 'SMSWithMedia' from the 'fabric' spec (components/schemas 'SMSWithMedia').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SMSWithMedia;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SMSWithMedia: pure data DTO (wire-response shape, not an exception).
