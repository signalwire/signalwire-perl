...
#
# Generated REST wire type 'SIPRefer' from the 'fabric' spec (components/schemas 'SIPRefer').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SIPRefer;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SIPRefer: pure data DTO (wire-response shape, not an exception).
