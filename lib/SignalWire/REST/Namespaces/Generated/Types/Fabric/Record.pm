...
#
# Generated REST wire type 'Record' from the 'fabric' spec (components/schemas 'Record').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Record;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Record: pure data DTO (wire-response shape, not an exception).
