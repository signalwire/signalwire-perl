...
#
# Generated REST wire type 'CallFlowCreateRequest' from the 'fabric' spec (components/schemas 'CallFlowCreateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CallFlowCreateRequest;
use strict;
use warnings;
use Moo;
