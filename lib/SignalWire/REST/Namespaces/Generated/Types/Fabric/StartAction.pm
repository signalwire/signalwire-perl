...
#
# Generated REST wire type 'StartAction' from the 'fabric' spec (components/schemas 'StartAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::StartAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::StartAction: pure data DTO (wire-response shape, not an exception).
