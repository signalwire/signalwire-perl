...
#
# Generated REST wire type 'SWMLAction' from the 'fabric' spec (components/schemas 'SWMLAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLAction: pure data DTO (wire-response shape, not an exception).
