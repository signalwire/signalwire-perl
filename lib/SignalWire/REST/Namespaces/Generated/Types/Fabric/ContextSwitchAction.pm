...
#
# Generated REST wire type 'ContextSwitchAction' from the 'fabric' spec (components/schemas 'ContextSwitchAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ContextSwitchAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ContextSwitchAction: pure data DTO (wire-response shape, not an exception).
