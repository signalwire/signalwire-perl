...
#
# Generated REST wire type 'Pay' from the 'fabric' spec (components/schemas 'Pay').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Pay;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Pay: pure data DTO (wire-response shape, not an exception).
