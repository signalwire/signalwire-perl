...
#
# Generated REST wire type 'Cond' from the 'fabric' spec (components/schemas 'Cond').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Cond;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Cond: pure data DTO (wire-response shape, not an exception).
