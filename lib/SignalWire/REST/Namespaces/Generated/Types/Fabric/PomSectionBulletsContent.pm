...
#
# Generated REST wire type 'PomSectionBulletsContent' from the 'fabric' spec (components/schemas 'PomSectionBulletsContent').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::PomSectionBulletsContent;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::PomSectionBulletsContent: pure data DTO (wire-response shape, not an exception).
