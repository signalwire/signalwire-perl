...
#
# Generated REST wire type 'SendSMS' from the 'fabric' spec (components/schemas 'SendSMS').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SendSMS;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SendSMS: pure data DTO (wire-response shape, not an exception).
