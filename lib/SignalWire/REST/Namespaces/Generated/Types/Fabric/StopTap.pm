...
#
# Generated REST wire type 'StopTap' from the 'fabric' spec (components/schemas 'StopTap').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::StopTap;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::StopTap: pure data DTO (wire-response shape, not an exception).
