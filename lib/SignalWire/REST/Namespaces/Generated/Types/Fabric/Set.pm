...
#
# Generated REST wire type 'Set' from the 'fabric' spec (components/schemas 'Set').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Set;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Set: pure data DTO (wire-response shape, not an exception).
