...
#
# Generated REST wire type 'HoldAction' from the 'fabric' spec (components/schemas 'HoldAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::HoldAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::HoldAction: pure data DTO (wire-response shape, not an exception).
