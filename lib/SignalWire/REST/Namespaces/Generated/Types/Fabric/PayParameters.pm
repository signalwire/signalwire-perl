...
#
# Generated REST wire type 'PayParameters' from the 'fabric' spec (components/schemas 'PayParameters').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::PayParameters;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::PayParameters: pure data DTO (wire-response shape, not an exception).
