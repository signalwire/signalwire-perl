...
#
# Generated REST wire type 'Prompt' from the 'fabric' spec (components/schemas 'Prompt').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Prompt;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Prompt: pure data DTO (wire-response shape, not an exception).
