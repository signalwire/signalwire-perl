...
#
# Generated REST wire type 'HangupAction' from the 'fabric' spec (components/schemas 'HangupAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::HangupAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::HangupAction: pure data DTO (wire-response shape, not an exception).
