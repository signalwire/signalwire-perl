...
#
# Generated REST wire type 'ResourceResponseSWMLWebhook' from the 'fabric' spec (components/schemas 'ResourceResponseSWMLWebhook').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSWMLWebhook;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSWMLWebhook: pure data DTO (wire-response shape, not an exception).
