...
#
# Generated REST wire type 'FabricAddress' from the 'fabric' spec (components/schemas 'FabricAddress').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddress;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddress: pure data DTO (wire-response shape, not an exception).
