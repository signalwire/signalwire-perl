...
#
# Generated REST wire type 'SetGlobalDataAction' from the 'fabric' spec (components/schemas 'SetGlobalDataAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SetGlobalDataAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SetGlobalDataAction: pure data DTO (wire-response shape, not an exception).
