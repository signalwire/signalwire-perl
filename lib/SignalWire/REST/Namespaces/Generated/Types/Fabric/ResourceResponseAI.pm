...
#
# Generated REST wire type 'ResourceResponseAI' from the 'fabric' spec (components/schemas 'ResourceResponseAI').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseAI;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseAI: pure data DTO (wire-response shape, not an exception).
