...
#
# Generated REST wire type 'SipEndpoint' from the 'fabric' spec (components/schemas 'SipEndpoint').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SipEndpoint;
use strict;
use warnings;
use Moo;
