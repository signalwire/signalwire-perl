...
#
# Generated REST wire type 'LanguageParams' from the 'fabric' spec (components/schemas 'LanguageParams').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::LanguageParams;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::LanguageParams: pure data DTO (wire-response shape, not an exception).
