...
#
# Generated REST wire type 'CallFlow' from the 'fabric' spec (components/schemas 'CallFlow').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CallFlow;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::CallFlow: pure data DTO (wire-response shape, not an exception).
