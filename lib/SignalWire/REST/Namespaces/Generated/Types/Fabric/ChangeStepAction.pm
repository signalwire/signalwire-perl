...
#
# Generated REST wire type 'ChangeStepAction' from the 'fabric' spec (components/schemas 'ChangeStepAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ChangeStepAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ChangeStepAction: pure data DTO (wire-response shape, not an exception).
