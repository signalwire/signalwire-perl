...
#
# Generated REST wire type 'Sleep' from the 'fabric' spec (components/schemas 'Sleep').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Sleep;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Sleep: pure data DTO (wire-response shape, not an exception).
