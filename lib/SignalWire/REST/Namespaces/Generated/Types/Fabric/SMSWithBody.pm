...
#
# Generated REST wire type 'SMSWithBody' from the 'fabric' spec (components/schemas 'SMSWithBody').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SMSWithBody;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SMSWithBody: pure data DTO (wire-response shape, not an exception).
