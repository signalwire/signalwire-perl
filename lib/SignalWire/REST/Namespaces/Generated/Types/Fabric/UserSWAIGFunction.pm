...
#
# Generated REST wire type 'UserSWAIGFunction' from the 'fabric' spec (components/schemas 'UserSWAIGFunction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::UserSWAIGFunction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::UserSWAIGFunction: pure data DTO (wire-response shape, not an exception).
