...
#
# Generated REST wire type 'ResourceResponseSipGateway' from the 'fabric' spec (components/schemas 'ResourceResponseSipGateway').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSipGateway;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSipGateway: pure data DTO (wire-response shape, not an exception).
