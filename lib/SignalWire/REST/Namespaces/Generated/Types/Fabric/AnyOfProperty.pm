...
#
# Generated REST wire type 'AnyOfProperty' from the 'fabric' spec (components/schemas 'AnyOfProperty').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::AnyOfProperty;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::AnyOfProperty: pure data DTO (wire-response shape, not an exception).
