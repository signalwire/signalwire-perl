...
#
# Generated REST wire type 'Play' from the 'fabric' spec (components/schemas 'Play').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Play;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Play: pure data DTO (wire-response shape, not an exception).
