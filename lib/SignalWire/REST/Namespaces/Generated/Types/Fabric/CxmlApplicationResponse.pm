...
#
# Generated REST wire type 'CxmlApplicationResponse' from the 'fabric' spec (components/schemas 'CxmlApplicationResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CxmlApplicationResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::CxmlApplicationResponse: pure data DTO (wire-response shape, not an exception).
