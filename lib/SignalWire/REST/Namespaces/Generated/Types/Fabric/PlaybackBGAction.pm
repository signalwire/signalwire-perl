...
#
# Generated REST wire type 'PlaybackBGAction' from the 'fabric' spec (components/schemas 'PlaybackBGAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::PlaybackBGAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::PlaybackBGAction: pure data DTO (wire-response shape, not an exception).
