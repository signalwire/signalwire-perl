...
#
# Generated REST wire type 'FabricAddressSubscriber' from the 'fabric' spec (components/schemas 'FabricAddressSubscriber').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddressSubscriber;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::FabricAddressSubscriber: pure data DTO (wire-response shape, not an exception).
