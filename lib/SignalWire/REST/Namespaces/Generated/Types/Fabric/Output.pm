...
#
# Generated REST wire type 'Output' from the 'fabric' spec (components/schemas 'Output').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Output;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Output: pure data DTO (wire-response shape, not an exception).
