...
#
# Generated REST wire type 'SWMLWebhookCreateRequest' from the 'fabric' spec (components/schemas 'SWMLWebhookCreateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLWebhookCreateRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLWebhookCreateRequest: pure data DTO (wire-response shape, not an exception).
