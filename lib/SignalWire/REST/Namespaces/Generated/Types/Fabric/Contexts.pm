...
#
# Generated REST wire type 'Contexts' from the 'fabric' spec (components/schemas 'Contexts').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Contexts;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Contexts: pure data DTO (wire-response shape, not an exception).
