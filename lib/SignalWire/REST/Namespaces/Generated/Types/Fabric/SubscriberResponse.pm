...
#
# Generated REST wire type 'SubscriberResponse' from the 'fabric' spec (components/schemas 'SubscriberResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SubscriberResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SubscriberResponse: pure data DTO (wire-response shape, not an exception).
