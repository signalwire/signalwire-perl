...
#
# Generated REST wire type 'SWMLWebhookResponse' from the 'fabric' spec (components/schemas 'SWMLWebhookResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLWebhookResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::SWMLWebhookResponse: pure data DTO (wire-response shape, not an exception).
