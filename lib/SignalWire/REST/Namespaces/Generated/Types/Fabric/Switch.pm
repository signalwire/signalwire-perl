...
#
# Generated REST wire type 'Switch' from the 'fabric' spec (components/schemas 'Switch').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Switch;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Switch: pure data DTO (wire-response shape, not an exception).
