...
#
# Generated REST wire type 'ChangeContextAction' from the 'fabric' spec (components/schemas 'ChangeContextAction').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ChangeContextAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ChangeContextAction: pure data DTO (wire-response shape, not an exception).
