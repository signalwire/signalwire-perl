...
#
# Generated REST wire type 'ResourceResponseSubscriber' from the 'fabric' spec (components/schemas 'ResourceResponseSubscriber').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSubscriber;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ResourceResponseSubscriber: pure data DTO (wire-response shape, not an exception).
