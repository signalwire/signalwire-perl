...
#
# Generated REST wire type 'ConferenceRoomResponse' from the 'fabric' spec (components/schemas 'ConferenceRoomResponse').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::ConferenceRoomResponse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::ConferenceRoomResponse: pure data DTO (wire-response shape, not an exception).
