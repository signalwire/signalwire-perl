...
#
# Generated REST wire type 'Request' from the 'fabric' spec (components/schemas 'Request').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::Request;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Fabric::Request: pure data DTO (wire-response shape, not an exception).
