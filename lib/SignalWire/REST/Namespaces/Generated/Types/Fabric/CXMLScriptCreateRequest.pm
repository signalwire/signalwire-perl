...
#
# Generated REST wire type 'CXMLScriptCreateRequest' from the 'fabric' spec (components/schemas 'CXMLScriptCreateRequest').
package SignalWire::REST::Namespaces::Generated::Types::Fabric::CXMLScriptCreateRequest;
use strict;
use warnings;
use Moo;
