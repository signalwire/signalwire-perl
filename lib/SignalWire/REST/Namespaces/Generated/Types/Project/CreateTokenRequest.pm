...
#
# Generated REST wire type 'CreateTokenRequest' from the 'project' spec (components/schemas 'CreateTokenRequest').
package SignalWire::REST::Namespaces::Generated::Types::Project::CreateTokenRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Project::CreateTokenRequest: pure data DTO (wire-response shape, not an exception).
