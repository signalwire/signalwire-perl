...
#
# Generated REST wire type 'CxmlConference' from the 'logs' spec (components/schemas 'CxmlConference').
package SignalWire::REST::Namespaces::Generated::Types::Logs::CxmlConference;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Logs::CxmlConference: pure data DTO (wire-response shape, not an exception).
