...
#
# Generated REST wire type 'ChargeDetail' from the 'message' spec (components/schemas 'ChargeDetail').
package SignalWire::REST::Namespaces::Generated::Types::Message::ChargeDetail;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Message::ChargeDetail: pure data DTO (wire-response shape, not an exception).
