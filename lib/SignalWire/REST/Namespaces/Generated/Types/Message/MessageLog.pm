...
#
# Generated REST wire type 'MessageLog' from the 'message' spec (components/schemas 'MessageLog').
package SignalWire::REST::Namespaces::Generated::Types::Message::MessageLog;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Message::MessageLog: pure data DTO (wire-response shape, not an exception).
