...
#
# Generated REST wire type 'VideoRoomVoiceLog' from the 'voice' spec (components/schemas 'VideoRoomVoiceLog').
package SignalWire::REST::Namespaces::Generated::Types::Voice::VideoRoomVoiceLog;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Voice::VideoRoomVoiceLog: pure data DTO (wire-response shape, not an exception).
