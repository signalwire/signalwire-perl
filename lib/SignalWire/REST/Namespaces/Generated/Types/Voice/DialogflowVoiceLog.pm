...
#
# Generated REST wire type 'DialogflowVoiceLog' from the 'voice' spec (components/schemas 'DialogflowVoiceLog').
package SignalWire::REST::Namespaces::Generated::Types::Voice::DialogflowVoiceLog;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Voice::DialogflowVoiceLog: pure data DTO (wire-response shape, not an exception).
