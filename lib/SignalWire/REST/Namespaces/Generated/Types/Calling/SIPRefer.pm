...
#
# Generated REST wire type 'SIPRefer' from the 'calling' spec (components/schemas 'SIPRefer').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SIPRefer;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SIPRefer: pure data DTO (wire-response shape, not an exception).
