...
#
# Generated REST wire type 'Label' from the 'calling' spec (components/schemas 'Label').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Label;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Label: pure data DTO (wire-response shape, not an exception).
