...
#
# Generated REST wire type 'HangupAction' from the 'calling' spec (components/schemas 'HangupAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::HangupAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::HangupAction: pure data DTO (wire-response shape, not an exception).
