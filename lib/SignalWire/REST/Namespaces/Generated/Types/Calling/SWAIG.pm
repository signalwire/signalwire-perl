...
#
# Generated REST wire type 'SWAIG' from the 'calling' spec (components/schemas 'SWAIG').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SWAIG;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SWAIG: pure data DTO (wire-response shape, not an exception).
