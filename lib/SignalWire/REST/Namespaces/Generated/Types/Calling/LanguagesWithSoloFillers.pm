...
#
# Generated REST wire type 'LanguagesWithSoloFillers' from the 'calling' spec (components/schemas 'LanguagesWithSoloFillers').
package SignalWire::REST::Namespaces::Generated::Types::Calling::LanguagesWithSoloFillers;
use strict;
use warnings;
use Moo;
