...
#
# Generated REST wire type 'LanguagesWithFillers' from the 'calling' spec (components/schemas 'LanguagesWithFillers').
package SignalWire::REST::Namespaces::Generated::Types::Calling::LanguagesWithFillers;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::LanguagesWithFillers: pure data DTO (wire-response shape, not an exception).
