...
#
# Generated REST wire type 'Execute' from the 'calling' spec (components/schemas 'Execute').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Execute;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Execute: pure data DTO (wire-response shape, not an exception).
