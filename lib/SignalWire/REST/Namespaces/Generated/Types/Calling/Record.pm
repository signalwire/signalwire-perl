...
#
# Generated REST wire type 'Record' from the 'calling' spec (components/schemas 'Record').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Record;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Record: pure data DTO (wire-response shape, not an exception).
