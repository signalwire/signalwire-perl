...
#
# Generated REST wire type 'SetMetaDataAction' from the 'calling' spec (components/schemas 'SetMetaDataAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SetMetaDataAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SetMetaDataAction: pure data DTO (wire-response shape, not an exception).
