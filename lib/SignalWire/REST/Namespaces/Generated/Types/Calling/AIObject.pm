...
#
# Generated REST wire type 'AIObject' from the 'calling' spec (components/schemas 'AIObject').
package SignalWire::REST::Namespaces::Generated::Types::Calling::AIObject;
use strict;
use warnings;
use Moo;
