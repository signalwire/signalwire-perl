...
#
# Generated REST wire type 'ConnectDeviceSingle' from the 'calling' spec (components/schemas 'ConnectDeviceSingle').
package SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceSingle;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceSingle: pure data DTO (wire-response shape, not an exception).
