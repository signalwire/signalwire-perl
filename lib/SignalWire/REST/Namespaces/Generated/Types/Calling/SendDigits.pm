...
#
# Generated REST wire type 'SendDigits' from the 'calling' spec (components/schemas 'SendDigits').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SendDigits;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SendDigits: pure data DTO (wire-response shape, not an exception).
