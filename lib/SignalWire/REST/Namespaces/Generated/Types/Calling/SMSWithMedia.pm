...
#
# Generated REST wire type 'SMSWithMedia' from the 'calling' spec (components/schemas 'SMSWithMedia').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SMSWithMedia;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SMSWithMedia: pure data DTO (wire-response shape, not an exception).
