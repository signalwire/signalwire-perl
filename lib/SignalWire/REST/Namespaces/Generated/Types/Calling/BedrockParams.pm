...
#
# Generated REST wire type 'BedrockParams' from the 'calling' spec (components/schemas 'BedrockParams').
package SignalWire::REST::Namespaces::Generated::Types::Calling::BedrockParams;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::BedrockParams: pure data DTO (wire-response shape, not an exception).
