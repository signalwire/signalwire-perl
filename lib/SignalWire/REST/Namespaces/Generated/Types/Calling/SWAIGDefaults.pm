...
#
# Generated REST wire type 'SWAIGDefaults' from the 'calling' spec (components/schemas 'SWAIGDefaults').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SWAIGDefaults;
use strict;
use warnings;
use Moo;
