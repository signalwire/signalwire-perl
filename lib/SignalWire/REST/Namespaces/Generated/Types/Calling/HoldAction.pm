...
#
# Generated REST wire type 'HoldAction' from the 'calling' spec (components/schemas 'HoldAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::HoldAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::HoldAction: pure data DTO (wire-response shape, not an exception).
