...
#
# Generated REST wire type 'Prompt' from the 'calling' spec (components/schemas 'Prompt').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Prompt;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Prompt: pure data DTO (wire-response shape, not an exception).
