...
#
# Generated REST wire type 'CallCreateParamsURL' from the 'calling' spec (components/schemas 'CallCreateParamsURL').
package SignalWire::REST::Namespaces::Generated::Types::Calling::CallCreateParamsURL;
use strict;
use warnings;
use Moo;
