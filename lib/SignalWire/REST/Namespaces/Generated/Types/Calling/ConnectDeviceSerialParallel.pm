...
#
# Generated REST wire type 'ConnectDeviceSerialParallel' from the 'calling' spec (components/schemas 'ConnectDeviceSerialParallel').
package SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceSerialParallel;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceSerialParallel: pure data DTO (wire-response shape, not an exception).
