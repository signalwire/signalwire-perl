...
#
# Generated REST wire type 'Hangup' from the 'calling' spec (components/schemas 'Hangup').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Hangup;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Hangup: pure data DTO (wire-response shape, not an exception).
