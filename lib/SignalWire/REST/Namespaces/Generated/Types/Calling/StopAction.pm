...
#
# Generated REST wire type 'StopAction' from the 'calling' spec (components/schemas 'StopAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::StopAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::StopAction: pure data DTO (wire-response shape, not an exception).
