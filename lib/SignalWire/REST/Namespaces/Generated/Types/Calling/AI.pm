...
#
# Generated REST wire type 'AI' from the 'calling' spec (components/schemas 'AI').
package SignalWire::REST::Namespaces::Generated::Types::Calling::AI;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::AI: pure data DTO (wire-response shape, not an exception).
