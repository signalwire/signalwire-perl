...
#
# Generated REST wire type 'CondElse' from the 'calling' spec (components/schemas 'CondElse').
package SignalWire::REST::Namespaces::Generated::Types::Calling::CondElse;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::CondElse: pure data DTO (wire-response shape, not an exception).
