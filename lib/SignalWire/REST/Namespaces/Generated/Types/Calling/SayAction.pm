...
#
# Generated REST wire type 'SayAction' from the 'calling' spec (components/schemas 'SayAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SayAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SayAction: pure data DTO (wire-response shape, not an exception).
