...
#
# Generated REST wire type 'Goto' from the 'calling' spec (components/schemas 'Goto').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Goto;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Goto: pure data DTO (wire-response shape, not an exception).
