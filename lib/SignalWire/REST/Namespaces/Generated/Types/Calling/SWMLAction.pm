...
#
# Generated REST wire type 'SWMLAction' from the 'calling' spec (components/schemas 'SWMLAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SWMLAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SWMLAction: pure data DTO (wire-response shape, not an exception).
