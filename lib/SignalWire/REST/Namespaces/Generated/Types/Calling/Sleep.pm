...
#
# Generated REST wire type 'Sleep' from the 'calling' spec (components/schemas 'Sleep').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Sleep;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Sleep: pure data DTO (wire-response shape, not an exception).
