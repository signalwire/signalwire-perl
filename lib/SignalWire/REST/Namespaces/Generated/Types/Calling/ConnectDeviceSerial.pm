...
#
# Generated REST wire type 'ConnectDeviceSerial' from the 'calling' spec (components/schemas 'ConnectDeviceSerial').
package SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceSerial;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceSerial: pure data DTO (wire-response shape, not an exception).
