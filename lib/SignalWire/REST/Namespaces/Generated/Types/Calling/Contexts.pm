...
#
# Generated REST wire type 'Contexts' from the 'calling' spec (components/schemas 'Contexts').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Contexts;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Contexts: pure data DTO (wire-response shape, not an exception).
