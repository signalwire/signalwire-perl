...
#
# Generated REST wire type 'Request' from the 'calling' spec (components/schemas 'Request').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Request;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Request: pure data DTO (wire-response shape, not an exception).
