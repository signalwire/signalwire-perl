...
#
# Generated REST wire type 'HangUpHookSWAIGFunction' from the 'calling' spec (components/schemas 'HangUpHookSWAIGFunction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::HangUpHookSWAIGFunction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::HangUpHookSWAIGFunction: pure data DTO (wire-response shape, not an exception).
