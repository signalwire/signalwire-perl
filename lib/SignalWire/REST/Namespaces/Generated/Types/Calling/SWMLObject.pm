...
#
# Generated REST wire type 'SWMLObject' from the 'calling' spec (components/schemas 'SWMLObject').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SWMLObject;
use strict;
use warnings;
use Moo;
