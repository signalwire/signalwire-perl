...
#
# Generated REST wire type 'Set' from the 'calling' spec (components/schemas 'Set').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Set;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Set: pure data DTO (wire-response shape, not an exception).
