...
#
# Generated REST wire type 'PlayWithURLS' from the 'calling' spec (components/schemas 'PlayWithURLS').
package SignalWire::REST::Namespaces::Generated::Types::Calling::PlayWithURLS;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::PlayWithURLS: pure data DTO (wire-response shape, not an exception).
