...
#
# Generated REST wire type 'SendFax' from the 'calling' spec (components/schemas 'SendFax').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SendFax;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SendFax: pure data DTO (wire-response shape, not an exception).
