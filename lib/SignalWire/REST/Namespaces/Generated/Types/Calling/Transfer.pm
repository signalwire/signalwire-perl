...
#
# Generated REST wire type 'Transfer' from the 'calling' spec (components/schemas 'Transfer').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Transfer;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Transfer: pure data DTO (wire-response shape, not an exception).
