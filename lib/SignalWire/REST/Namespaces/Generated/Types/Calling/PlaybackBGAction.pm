...
#
# Generated REST wire type 'PlaybackBGAction' from the 'calling' spec (components/schemas 'PlaybackBGAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::PlaybackBGAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::PlaybackBGAction: pure data DTO (wire-response shape, not an exception).
