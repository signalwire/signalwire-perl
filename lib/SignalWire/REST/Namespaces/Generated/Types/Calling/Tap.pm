...
#
# Generated REST wire type 'Tap' from the 'calling' spec (components/schemas 'Tap').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Tap;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Tap: pure data DTO (wire-response shape, not an exception).
