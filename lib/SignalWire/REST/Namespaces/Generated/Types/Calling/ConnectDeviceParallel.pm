...
#
# Generated REST wire type 'ConnectDeviceParallel' from the 'calling' spec (components/schemas 'ConnectDeviceParallel').
package SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceParallel;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::ConnectDeviceParallel: pure data DTO (wire-response shape, not an exception).
