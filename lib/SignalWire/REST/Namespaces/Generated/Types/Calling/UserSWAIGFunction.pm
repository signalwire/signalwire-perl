...
#
# Generated REST wire type 'UserSWAIGFunction' from the 'calling' spec (components/schemas 'UserSWAIGFunction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::UserSWAIGFunction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::UserSWAIGFunction: pure data DTO (wire-response shape, not an exception).
