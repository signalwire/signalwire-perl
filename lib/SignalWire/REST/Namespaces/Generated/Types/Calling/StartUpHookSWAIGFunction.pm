...
#
# Generated REST wire type 'StartUpHookSWAIGFunction' from the 'calling' spec (components/schemas 'StartUpHookSWAIGFunction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::StartUpHookSWAIGFunction;
use strict;
use warnings;
use Moo;
