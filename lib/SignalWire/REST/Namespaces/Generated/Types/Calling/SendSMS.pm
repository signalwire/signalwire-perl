...
#
# Generated REST wire type 'SendSMS' from the 'calling' spec (components/schemas 'SendSMS').
package SignalWire::REST::Namespaces::Generated::Types::Calling::SendSMS;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::SendSMS: pure data DTO (wire-response shape, not an exception).
