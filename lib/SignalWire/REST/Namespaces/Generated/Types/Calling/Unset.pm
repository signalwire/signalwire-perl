...
#
# Generated REST wire type 'Unset' from the 'calling' spec (components/schemas 'Unset').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Unset;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Unset: pure data DTO (wire-response shape, not an exception).
