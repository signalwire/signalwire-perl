...
#
# Generated REST wire type 'JoinRoom' from the 'calling' spec (components/schemas 'JoinRoom').
package SignalWire::REST::Namespaces::Generated::Types::Calling::JoinRoom;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::JoinRoom: pure data DTO (wire-response shape, not an exception).
