...
#
# Generated REST wire type 'PomSectionBodyContent' from the 'calling' spec (components/schemas 'PomSectionBodyContent').
package SignalWire::REST::Namespaces::Generated::Types::Calling::PomSectionBodyContent;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::PomSectionBodyContent: pure data DTO (wire-response shape, not an exception).
