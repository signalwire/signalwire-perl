...
#
# Generated REST wire type 'StartAction' from the 'calling' spec (components/schemas 'StartAction').
package SignalWire::REST::Namespaces::Generated::Types::Calling::StartAction;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::StartAction: pure data DTO (wire-response shape, not an exception).
