...
#
# Generated REST wire type 'Connect' from the 'calling' spec (components/schemas 'Connect').
package SignalWire::REST::Namespaces::Generated::Types::Calling::Connect;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::Connect: pure data DTO (wire-response shape, not an exception).
