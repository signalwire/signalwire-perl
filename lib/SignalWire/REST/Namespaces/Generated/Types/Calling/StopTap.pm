...
#
# Generated REST wire type 'StopTap' from the 'calling' spec (components/schemas 'StopTap').
package SignalWire::REST::Namespaces::Generated::Types::Calling::StopTap;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::Calling::StopTap: pure data DTO (wire-response shape, not an exception).
