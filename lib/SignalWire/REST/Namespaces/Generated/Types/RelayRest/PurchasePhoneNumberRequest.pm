...
#
# Generated REST wire type 'PurchasePhoneNumberRequest' from the 'relay_rest' spec (components/schemas 'PurchasePhoneNumberRequest').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::PurchasePhoneNumberRequest;
use strict;
use warnings;
use Moo;
