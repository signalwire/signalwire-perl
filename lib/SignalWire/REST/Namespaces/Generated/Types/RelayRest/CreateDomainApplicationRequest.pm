...
#
# Generated REST wire type 'CreateDomainApplicationRequest' from the 'relay_rest' spec (components/schemas 'CreateDomainApplicationRequest').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::CreateDomainApplicationRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::CreateDomainApplicationRequest: pure data DTO (wire-response shape, not an exception).
