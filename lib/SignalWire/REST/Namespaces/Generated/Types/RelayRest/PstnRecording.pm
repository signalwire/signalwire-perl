...
#
# Generated REST wire type 'PstnRecording' from the 'relay_rest' spec (components/schemas 'PstnRecording').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::PstnRecording;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::PstnRecording: pure data DTO (wire-response shape, not an exception).
