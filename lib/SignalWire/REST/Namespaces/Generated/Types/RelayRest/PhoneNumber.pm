...
#
# Generated REST wire type 'PhoneNumber' from the 'relay_rest' spec (components/schemas 'PhoneNumber').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::PhoneNumber;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::PhoneNumber: pure data DTO (wire-response shape, not an exception).
