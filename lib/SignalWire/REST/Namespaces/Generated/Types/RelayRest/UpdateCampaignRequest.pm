...
#
# Generated REST wire type 'UpdateCampaignRequest' from the 'relay_rest' spec (components/schemas 'UpdateCampaignRequest').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::UpdateCampaignRequest;
use strict;
use warnings;
use Moo;
