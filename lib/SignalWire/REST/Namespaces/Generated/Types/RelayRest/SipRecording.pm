...
#
# Generated REST wire type 'SipRecording' from the 'relay_rest' spec (components/schemas 'SipRecording').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::SipRecording;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::SipRecording: pure data DTO (wire-response shape, not an exception).
