...
#
# Generated REST wire type 'SipEndpoint' from the 'relay_rest' spec (components/schemas 'SipEndpoint').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::SipEndpoint;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::SipEndpoint: pure data DTO (wire-response shape, not an exception).
