...
#
# Generated REST wire type 'UpdatePhoneNumberRequest' from the 'relay_rest' spec (components/schemas 'UpdatePhoneNumberRequest').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::UpdatePhoneNumberRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::UpdatePhoneNumberRequest: pure data DTO (wire-response shape, not an exception).
...
has 'message_relay_application'              => ( is => 'ro' );
