...
#
# Generated REST wire type 'CnamInfo' from the 'relay_rest' spec (components/schemas 'CnamInfo').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::CnamInfo;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::CnamInfo: pure data DTO (wire-response shape, not an exception).
