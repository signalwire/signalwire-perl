...
#
# Generated REST wire type 'UpdateSipEndpointRequest' from the 'relay_rest' spec (components/schemas 'UpdateSipEndpointRequest').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::UpdateSipEndpointRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::UpdateSipEndpointRequest: pure data DTO (wire-response shape, not an exception).
