...
#
# Generated REST wire type 'CreateSipEndpointRequest' from the 'relay_rest' spec (components/schemas 'CreateSipEndpointRequest').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::CreateSipEndpointRequest;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::CreateSipEndpointRequest: pure data DTO (wire-response shape, not an exception).
