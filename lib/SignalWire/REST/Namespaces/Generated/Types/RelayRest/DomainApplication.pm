...
#
# Generated REST wire type 'DomainApplication' from the 'relay_rest' spec (components/schemas 'DomainApplication').
package SignalWire::REST::Namespaces::Generated::Types::RelayRest::DomainApplication;
use strict;
use warnings;
use Moo;

# struct SignalWire::REST::Namespaces::Generated::Types::RelayRest::DomainApplication: pure data DTO (wire-response shape, not an exception).
