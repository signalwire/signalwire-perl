...
#
# Generated REST resource 'VideoRoomTokens' (video spec, base BaseResource).
package SignalWire::REST::Namespaces::Generated::VideoRoomTokens;
use strict;
use warnings;
use Moo;
...
around BUILDARGS => sub {
    ...
    $args{_base_path} //= '/api/video/room_tokens';
