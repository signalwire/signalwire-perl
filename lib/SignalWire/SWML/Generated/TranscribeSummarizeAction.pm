...
#
# Generated SWML verb config type 'TranscribeSummarizeAction' ($defs schema 'TranscribeSummarizeAction').
package SignalWire::SWML::Generated::TranscribeSummarizeAction;
use strict;
use warnings;
use Moo;
