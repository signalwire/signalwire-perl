...
#
# Generated SWML verb config type 'OmitPropertiesBedrockPostPomptTextOmittedPromptProps' ($defs schema 'OmitPropertiesBedrockPostPomptTextOmittedPromptProps').
package SignalWire::SWML::Generated::OmitPropertiesBedrockPostPomptTextOmittedPromptProps;
use strict;
use warnings;
use Moo;
