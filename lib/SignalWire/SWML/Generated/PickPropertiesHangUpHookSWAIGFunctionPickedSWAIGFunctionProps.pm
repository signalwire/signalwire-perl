...
#
# Generated SWML verb config type 'PickPropertiesHangUpHookSWAIGFunctionPickedSWAIGFunctionProps' ($defs schema 'PickPropertiesHangUpHookSWAIGFunctionPickedSWAIGFunctionProps').
package SignalWire::SWML::Generated::PickPropertiesHangUpHookSWAIGFunctionPickedSWAIGFunctionProps;
use strict;
use warnings;
use Moo;
