...
#
# Generated SWML verb config type 'StopRecordCallConfig' (flattened SWMLMethod verb 'stop_record_call' config).
package SignalWire::SWML::Generated::StopRecordCallConfig;
use strict;
use warnings;
use Moo;
