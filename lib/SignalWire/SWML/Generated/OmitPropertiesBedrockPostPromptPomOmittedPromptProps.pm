...
#
# Generated SWML verb config type 'OmitPropertiesBedrockPostPromptPomOmittedPromptProps' ($defs schema 'OmitPropertiesBedrockPostPromptPomOmittedPromptProps').
package SignalWire::SWML::Generated::OmitPropertiesBedrockPostPromptPomOmittedPromptProps;
use strict;
use warnings;
use Moo;
