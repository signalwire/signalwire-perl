...
#
# Generated SWML verb config type 'OmitPropertiesBedrockPromptPomOmittedPromptProps' ($defs schema 'OmitPropertiesBedrockPromptPomOmittedPromptProps').
package SignalWire::SWML::Generated::OmitPropertiesBedrockPromptPomOmittedPromptProps;
use strict;
use warnings;
use Moo;
