...
#
# Generated SWML verb config type 'OmitPropertiesBedrockPromptTextOmittedPromptProps' ($defs schema 'OmitPropertiesBedrockPromptTextOmittedPromptProps').
package SignalWire::SWML::Generated::OmitPropertiesBedrockPromptTextOmittedPromptProps;
use strict;
use warnings;
use Moo;
