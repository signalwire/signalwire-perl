...
#
# Generated SWML verb config type 'SummarizeConversationSWAIGFunction' ($defs schema 'SummarizeConversationSWAIGFunction').
package SignalWire::SWML::Generated::SummarizeConversationSWAIGFunction;
use strict;
use warnings;
use Moo;
