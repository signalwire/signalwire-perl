...
#
# Generated SWML verb config type 'PickPropertiesStartUpHookSWAIGFunctionPickedSWAIGFunctionProps' ($defs schema 'PickPropertiesStartUpHookSWAIGFunctionPickedSWAIGFunctionProps').
package SignalWire::SWML::Generated::PickPropertiesStartUpHookSWAIGFunctionPickedSWAIGFunctionProps;
use strict;
use warnings;
use Moo;
