...
#
# Generated SWML verb config type 'StartUpHookSWAIGFunction' ($defs schema 'StartUpHookSWAIGFunction').
package SignalWire::SWML::Generated::StartUpHookSWAIGFunction;
use strict;
use warnings;
use Moo;
