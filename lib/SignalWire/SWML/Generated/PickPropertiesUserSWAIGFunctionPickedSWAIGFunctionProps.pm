...
#
# Generated SWML verb config type 'PickPropertiesUserSWAIGFunctionPickedSWAIGFunctionProps' ($defs schema 'PickPropertiesUserSWAIGFunctionPickedSWAIGFunctionProps').
package SignalWire::SWML::Generated::PickPropertiesUserSWAIGFunctionPickedSWAIGFunctionProps;
use strict;
use warnings;
use Moo;
