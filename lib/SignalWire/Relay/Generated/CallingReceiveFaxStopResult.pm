...
#
# Generated RELAY protocol wire type 'CallingReceiveFaxStopResult' (method 'calling.receive_fax.stop', result).
package SignalWire::Relay::Generated::CallingReceiveFaxStopResult;
use strict;
use warnings;
use Moo;
