...
#
# Generated RELAY protocol wire type 'CallingJoinConferenceResult' (method 'calling.join_conference', result).
package SignalWire::Relay::Generated::CallingJoinConferenceResult;
use strict;
use warnings;
use Moo;
