...
#
# Generated RELAY protocol wire type 'CallingCollectStopResult' (method 'calling.collect.stop', result).
package SignalWire::Relay::Generated::CallingCollectStopResult;
use strict;
use warnings;
use Moo;
