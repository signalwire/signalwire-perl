...
#
# Generated RELAY protocol wire type 'CallingSendFaxStopParams' (method 'calling.send_fax.stop', params).
package SignalWire::Relay::Generated::CallingSendFaxStopParams;
use strict;
use warnings;
use Moo;
