...
#
# Generated RELAY protocol wire type 'CallingReceiveFaxStopParams' (method 'calling.receive_fax.stop', params).
package SignalWire::Relay::Generated::CallingReceiveFaxStopParams;
use strict;
use warnings;
use Moo;
