...
#
# Generated RELAY protocol wire type 'CallingLiveTranslateResult' (method 'calling.live_translate', result).
package SignalWire::Relay::Generated::CallingLiveTranslateResult;
use strict;
use warnings;
use Moo;
