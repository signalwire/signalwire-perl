...
#
# Generated RELAY protocol wire type 'CallingCollectStopParams' (method 'calling.collect.stop', params).
package SignalWire::Relay::Generated::CallingCollectStopParams;
use strict;
use warnings;
use Moo;
