...
#
# Generated RELAY protocol wire type 'CallingPlayVolumeParams' (method 'calling.play.volume', params).
package SignalWire::Relay::Generated::CallingPlayVolumeParams;
use strict;
use warnings;
use Moo;
