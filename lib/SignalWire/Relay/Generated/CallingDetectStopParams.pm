...
#
# Generated RELAY protocol wire type 'CallingDetectStopParams' (method 'calling.detect.stop', params).
package SignalWire::Relay::Generated::CallingDetectStopParams;
use strict;
use warnings;
use Moo;
