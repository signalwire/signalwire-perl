...
#
# Generated RELAY protocol wire type 'CallingLiveTranslateParams' (method 'calling.live_translate', params).
package SignalWire::Relay::Generated::CallingLiveTranslateParams;
use strict;
use warnings;
use Moo;
