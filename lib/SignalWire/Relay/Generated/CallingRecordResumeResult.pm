...
#
# Generated RELAY protocol wire type 'CallingRecordResumeResult' (method 'calling.record.resume', result).
package SignalWire::Relay::Generated::CallingRecordResumeResult;
use strict;
use warnings;
use Moo;
