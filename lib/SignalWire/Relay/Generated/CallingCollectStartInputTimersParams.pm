...
#
# Generated RELAY protocol wire type 'CallingCollectStartInputTimersParams' (method 'calling.collect.start_input_timers', params).
package SignalWire::Relay::Generated::CallingCollectStartInputTimersParams;
use strict;
use warnings;
use Moo;
