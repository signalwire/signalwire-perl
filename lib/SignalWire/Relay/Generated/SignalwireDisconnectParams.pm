...
#
# Generated RELAY protocol wire type 'SignalwireDisconnectParams' (method 'signalwire.disconnect', params).
package SignalWire::Relay::Generated::SignalwireDisconnectParams;
use strict;
use warnings;
use Moo;
