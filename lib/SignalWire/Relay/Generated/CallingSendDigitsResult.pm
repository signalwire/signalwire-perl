...
#
# Generated RELAY protocol wire type 'CallingSendDigitsResult' (method 'calling.send_digits', result).
package SignalWire::Relay::Generated::CallingSendDigitsResult;
use strict;
use warnings;
use Moo;
