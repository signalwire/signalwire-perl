...
#
# Generated RELAY protocol wire type 'CallingTapResult' (method 'calling.tap', result).
package SignalWire::Relay::Generated::CallingTapResult;
use strict;
use warnings;
use Moo;
