...
#
# Generated RELAY protocol wire type 'CallingPlayAndCollectVolumeResult' (method 'calling.play_and_collect.volume', result).
package SignalWire::Relay::Generated::CallingPlayAndCollectVolumeResult;
use strict;
use warnings;
use Moo;
