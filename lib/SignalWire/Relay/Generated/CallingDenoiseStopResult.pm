...
#
# Generated RELAY protocol wire type 'CallingDenoiseStopResult' (method 'calling.denoise.stop', result).
package SignalWire::Relay::Generated::CallingDenoiseStopResult;
use strict;
use warnings;
use Moo;
