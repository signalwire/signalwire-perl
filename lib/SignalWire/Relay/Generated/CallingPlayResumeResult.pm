...
#
# Generated RELAY protocol wire type 'CallingPlayResumeResult' (method 'calling.play.resume', result).
package SignalWire::Relay::Generated::CallingPlayResumeResult;
use strict;
use warnings;
use Moo;
