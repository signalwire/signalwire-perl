...
#
# Generated RELAY protocol wire type 'CallingRecordResumeParams' (method 'calling.record.resume', params).
package SignalWire::Relay::Generated::CallingRecordResumeParams;
use strict;
use warnings;
use Moo;
