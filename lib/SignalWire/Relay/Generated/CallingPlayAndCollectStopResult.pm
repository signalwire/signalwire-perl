...
#
# Generated RELAY protocol wire type 'CallingPlayAndCollectStopResult' (method 'calling.play_and_collect.stop', result).
package SignalWire::Relay::Generated::CallingPlayAndCollectStopResult;
use strict;
use warnings;
use Moo;
