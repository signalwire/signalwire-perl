...
#
# Generated RELAY protocol wire type 'CallingPlayVolumeResult' (method 'calling.play.volume', result).
package SignalWire::Relay::Generated::CallingPlayVolumeResult;
use strict;
use warnings;
use Moo;
