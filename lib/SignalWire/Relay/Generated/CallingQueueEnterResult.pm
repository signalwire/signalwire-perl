...
#
# Generated RELAY protocol wire type 'CallingQueueEnterResult' (method 'calling.queue.enter', result).
package SignalWire::Relay::Generated::CallingQueueEnterResult;
use strict;
use warnings;
use Moo;
