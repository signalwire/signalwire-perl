...
#
# Generated RELAY protocol wire type 'CallingReceiveFaxResult' (method 'calling.receive_fax', result).
package SignalWire::Relay::Generated::CallingReceiveFaxResult;
use strict;
use warnings;
use Moo;
