...
#
# Generated RELAY protocol wire type 'CallingPlayAndCollectStopParams' (method 'calling.play_and_collect.stop', params).
package SignalWire::Relay::Generated::CallingPlayAndCollectStopParams;
use strict;
use warnings;
use Moo;
