...
#
# Generated RELAY protocol wire type 'CallingQueueLeaveParams' (method 'calling.queue.leave', params).
package SignalWire::Relay::Generated::CallingQueueLeaveParams;
use strict;
use warnings;
use Moo;
