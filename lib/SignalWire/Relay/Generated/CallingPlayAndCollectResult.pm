...
#
# Generated RELAY protocol wire type 'CallingPlayAndCollectResult' (method 'calling.play_and_collect', result).
package SignalWire::Relay::Generated::CallingPlayAndCollectResult;
use strict;
use warnings;
use Moo;
