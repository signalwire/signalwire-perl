...
#
# Generated RELAY protocol wire type 'CallingRecordStopResult' (method 'calling.record.stop', result).
package SignalWire::Relay::Generated::CallingRecordStopResult;
use strict;
use warnings;
use Moo;
