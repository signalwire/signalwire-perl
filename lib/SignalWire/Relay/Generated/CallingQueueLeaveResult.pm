...
#
# Generated RELAY protocol wire type 'CallingQueueLeaveResult' (method 'calling.queue.leave', result).
package SignalWire::Relay::Generated::CallingQueueLeaveResult;
use strict;
use warnings;
use Moo;
