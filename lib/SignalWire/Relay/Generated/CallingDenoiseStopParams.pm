...
#
# Generated RELAY protocol wire type 'CallingDenoiseStopParams' (method 'calling.denoise.stop', params).
package SignalWire::Relay::Generated::CallingDenoiseStopParams;
use strict;
use warnings;
use Moo;
