...
#
# Generated RELAY protocol wire type 'CallingLeaveConferenceResult' (method 'calling.leave_conference', result).
package SignalWire::Relay::Generated::CallingLeaveConferenceResult;
use strict;
use warnings;
use Moo;
