...
#
# Generated RELAY protocol wire type 'CallingPlayResumeParams' (method 'calling.play.resume', params).
package SignalWire::Relay::Generated::CallingPlayResumeParams;
use strict;
use warnings;
use Moo;
