...
#
# Generated RELAY protocol wire type 'CallingRecordPauseParams' (method 'calling.record.pause', params).
package SignalWire::Relay::Generated::CallingRecordPauseParams;
use strict;
use warnings;
use Moo;
