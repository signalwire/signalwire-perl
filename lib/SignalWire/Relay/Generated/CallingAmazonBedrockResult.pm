...
#
# Generated RELAY protocol wire type 'CallingAmazonBedrockResult' (method 'calling.amazon_bedrock', result).
package SignalWire::Relay::Generated::CallingAmazonBedrockResult;
use strict;
use warnings;
use Moo;
