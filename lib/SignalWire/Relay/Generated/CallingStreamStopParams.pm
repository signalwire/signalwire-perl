...
#
# Generated RELAY protocol wire type 'CallingStreamStopParams' (method 'calling.stream.stop', params).
package SignalWire::Relay::Generated::CallingStreamStopParams;
use strict;
use warnings;
use Moo;
