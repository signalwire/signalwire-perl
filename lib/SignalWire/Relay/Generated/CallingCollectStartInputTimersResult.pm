...
#
# Generated RELAY protocol wire type 'CallingCollectStartInputTimersResult' (method 'calling.collect.start_input_timers', result).
package SignalWire::Relay::Generated::CallingCollectStartInputTimersResult;
use strict;
use warnings;
use Moo;
