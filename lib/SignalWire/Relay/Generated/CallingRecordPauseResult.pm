...
#
# Generated RELAY protocol wire type 'CallingRecordPauseResult' (method 'calling.record.pause', result).
package SignalWire::Relay::Generated::CallingRecordPauseResult;
use strict;
use warnings;
use Moo;
