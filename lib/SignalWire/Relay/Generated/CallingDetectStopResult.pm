...
#
# Generated RELAY protocol wire type 'CallingDetectStopResult' (method 'calling.detect.stop', result).
package SignalWire::Relay::Generated::CallingDetectStopResult;
use strict;
use warnings;
use Moo;
