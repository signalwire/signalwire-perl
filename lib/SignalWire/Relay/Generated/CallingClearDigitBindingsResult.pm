...
#
# Generated RELAY protocol wire type 'CallingClearDigitBindingsResult' (method 'calling.clear_digit_bindings', result).
package SignalWire::Relay::Generated::CallingClearDigitBindingsResult;
use strict;
use warnings;
use Moo;
