...
#
# Generated RELAY protocol wire type 'CallingQueueEnterParams' (method 'calling.queue.enter', params).
package SignalWire::Relay::Generated::CallingQueueEnterParams;
use strict;
use warnings;
use Moo;
