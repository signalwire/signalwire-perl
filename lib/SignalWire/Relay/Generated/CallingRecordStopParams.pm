...
#
# Generated RELAY protocol wire type 'CallingRecordStopParams' (method 'calling.record.stop', params).
package SignalWire::Relay::Generated::CallingRecordStopParams;
use strict;
use warnings;
use Moo;
