...
- relay/examples/relay_ivr_connect.pl — opens a live RELAY WebSocket to SIGNALWIRE_SPACE; the shared harness runs only mock_signalwire (REST), no mock_relay, so this needs a real relay endpoint (same class + reason as the owner-approved php relay/examples/relay_ivr_connect.php, approver: user, 2026-07-09; ratified for these 4 perl RELAY examples: user, 2026-07-21)
