...
subtest 'relay_applications' => sub {
    isa_ok( $client->fabric->relay_applications,
        'SignalWire::REST::Namespaces::Generated::RelayApplications' );
};
...
subtest 'conference_rooms' => sub {
    isa_ok( $client->fabric->conference_rooms,
        'SignalWire::REST::Namespaces::Generated::ConferenceRooms' );
};
...
subtest 'sip_endpoints' => sub {
    isa_ok( $client->fabric->sip_endpoints,
        'SignalWire::REST::Namespaces::Generated::SipEndpoints' );
};
...
subtest 'addresses and tokens' => sub {
    isa_ok( $client->fabric->addresses,
        'SignalWire::REST::Namespaces::Generated::FabricAddresses' );
