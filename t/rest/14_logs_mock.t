...
subtest 'TestMessageLogs' => sub {
    subtest 'test_list_returns_dict' => sub {
        ...
        is( $last->{matched_route},
            'message.list_message_logs', 'matched route is message.list_message_logs' );
    };
...
subtest 'TestVoiceLogs' => sub {
    subtest 'test_list_returns_dict' => sub {
        ...
        is( $last->{matched_route},
            'voice.list_voice_logs', 'matched route is voice.list_voice_logs' );
    };
...
subtest 'TestFaxLogs' => sub {
    subtest 'test_list_returns_dict' => sub {
        ...
        is( $last->{matched_route}, 'fax.list_fax_logs', 'matched route is fax.list_fax_logs' );
    };
...
subtest 'TestConferenceLogs' => sub {
    subtest 'test_list_returns_dict' => sub {
        ...
        is( $last->{matched_route},
            'logs.list_conferences', 'matched route is logs.list_conferences' );
    };
};
